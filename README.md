...
<body>
   ...
   <section id="sluzby" style="background: #fcfcfc; padding: 80px 0;">
    ...
    <section id="vybaveni" class="container">
        ...
        <div class="grid-fixed">
            ...
            <div class="card">
                <div class="card-img" style="background-image: url('ubrus na pivnici set.jpg');"></div>
                <div class="card-content">
            ...
            <div class="card">
                ...
                <div class="card-content">
                    ...
                    <div class="price">750 Kč <span>/ bez náplně</span></div>
                    <div class="note">Cena za 1 až 2 dny zapůjčení</div>
                    <a href="#kontakt" class="btn-main">POPTAT TERMÍN</a>
                </div>
            </div>
   ...
   <section id="kontakt" style="background: #fff; padding: 60px 0; width: 100%; overflow-x: hidden;">
        <div class="section-title">
            <h2>Napište nám</h2>
            <div class="divider"></div>
